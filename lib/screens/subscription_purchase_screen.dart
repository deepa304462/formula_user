    ...
    return Scaffold(
      ...
      body: Consumer<SubscriptionManager>(
        builder: (context, subscriptionManager, _) {
          ...
          if(subscriptionManager.isPrime){
            return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: Text(
                                "You are using prime",
                                style: Styles.textWith20withBold(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "₹${item.price}0",
                                      style: Styles.textWith20withBold500(
                                          Colours.white),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(
                                ...
                                ElevatedButton(
                                    style: ButtonStyle(
                                        ...
                                        backgroundColor: MaterialStateColor.resolveWith((states){
                                          if(states.contains(MaterialState.disabled)){
                                            return Colours.gret500;
                                          }else{
                                            return Colours.buttonColor1;
                                          }
                                        })),
                                    ...
                                    child: Text(
                                      "Buy",
                                      style: Styles.textWith18withBold(
                                          Colours.white),
                                    ))
                              ],
                            ),
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: List.generate(
                            subscriptionManager.subscriptionsUIList.length,
                                (indexDot) => Container(
                              margin:
